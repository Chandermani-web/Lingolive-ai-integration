      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 p-4">
        {displayUsers?.length > 0 ? (
          displayUsers.map((u) => (
            <div
              key={u._id}
              className="bg-gradient-to-br from-gray-800 via-gray-900 to-black rounded-2xl overflow-hidden shadow-xl hover:shadow-2xl transition-shadow duration-300 relative"
            >
              {/* Cover Image */}
              ...
              <div className="p-5 text-white">
                ...
                <div className="flex items-center space-x-4 ">
                  ...
                  />
                  <div>
                    <h3 className="font-bold text-lg text-white cursor-pointer hover:underline"
